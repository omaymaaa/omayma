...
void rotozoom()
{
    ...
    ecran = SDL_SetVideoMode(1000, 900, 32, SDL_HWSURFACE);
    SDL_WM_SetCaption("rotations avec SDL_gfx oumaima", NULL);
 
    image = SDL_LoadBMP("s.bmp");
